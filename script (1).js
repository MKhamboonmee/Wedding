...
createHearts('floatingHearts3', 15);
createHearts('floatingHearts4', 15);
...
const animateOnScroll = () => {
  const elements = document.querySelectorAll('.detail-card, .story-card, .timeline-item');
...
document.querySelectorAll('.detail-card, .story-card, .timeline-item').forEach(el => {
  el.style.opacity = '0';
